	...
	*/	
	...
	function attach_EasyGallery_scripts() {
		...
		if ($wpEasyGalleryOptions['hide_social'] == 'true' && $wpEasyGalleryOptions['hide_overlay'] == 'false') {
			wp_register_script('easyGalleryLoader', plugins_url( '/js/EasyGalleryLoader_hideSocial.js', __FILE__ ), array('prettyPhoto', 'jquery'));
		}
		else if ($wpEasyGalleryOptions['hide_social'] == 'false' && $wpEasyGalleryOptions['hide_overlay'] == 'true') {
			wp_register_script('easyGalleryLoader', plugins_url( '/js/EasyGalleryLoader_hideOverlay.js', __FILE__ ), array('prettyPhoto', 'jquery'));
		}
		else if ($wpEasyGalleryOptions['hide_social'] == 'true' && $wpEasyGalleryOptions['hide_overlay'] == 'true') {
			wp_register_script('easyGalleryLoader', plugins_url( '/js/EasyGalleryLoader_hideOverlaySocial.js', __FILE__ ), array('prettyPhoto', 'jquery'));
		}
		else {
