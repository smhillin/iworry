...
function optionsframework_options() {
	...
	$options[] = array(
		'name' => __('Misc', 'options_framework_theme'),
		'type' => 'heading');

		$options[] = array(
			'name' => __('Move slider automatically?', 'options_framework_theme'),
			'desc' => __('If one of your slides is a video, set this to no', 'options_framework_theme'),
			'id' => 'sliderauto',
			'type' => 'radio',
			'options' => $slider_array);

	$options[] = array(
		'name' => __('Shocker', 'options_framework_theme'),
		'desc' => 'The line of text below the slider. Place a line-break where you want to change from red to grey text.',
		'id' => 'shocker',
		'type' => 'textarea');

	$options[] = array(
		'name' => __('Call to action', 'options_framework_theme'),
		'id' => 'c2a',
		'type' => 'textarea');
	$options[] = array(
		'name' => __('Call to action target', 'options_framework_theme'),
		'desc' => 'Target page for the call to action button.',
		'id' => 'c2aurl',
		'type' => 'select',
		'options' => $options_pages);
	$options[] = array(
		'name' => __('Inner page header', 'options_framework_theme'),
		'id' => 'pageheader',
		'desc' => 'Header image for internal pages',
		'type' => 'upload');

	$options[] = array(
		'name' => __('Links', 'options_framework_theme'),
		'type' => 'heading');

		$options[] = array(
			'name' => __('Donate URL', 'options_framework_theme'),
			'id' => 'donatelink',
			'type' => 'text');
		$options[] = array(
			'name' => __('FB URL', 'options_framework_theme'),
			'id' => 'fburl',
			'type' => 'text');
		$options[] = array(
	...
	$options[] = array(
		'name' => __('Launchpad Blocks', 'options_framework_theme'),
		'type' => 'heading');


			$options[] = array(
				'name' => __('Block 1 Img', 'options_framework_theme'),
				'id' => 'block1img',
				'type' => 'upload');
			$options[] = array(
				'name' => __('Block 1 Text', 'options_framework_theme'),
				'id' => 'block1text',
				'type' => 'text');
			$options[] = array(
				'name' => __('Block 1 Target', 'options_framework_theme'),
				'id' => 'block1url',
				'type' => 'select',
				'options' => $options_pages);
			...
			$options[] = array(
				'name' => __('Block 2 Img', 'options_framework_theme'),
				'id' => 'block2img',
				'type' => 'upload');
			$options[] = array(
				'name' => __('Block 2 Text', 'options_framework_theme'),
				'id' => 'block2text',
				'type' => 'text');
			$options[] = array(
				'name' => __('Block 2 Target', 'options_framework_theme'),
				'id' => 'block2url',
				'type' => 'select',
				'options' => $options_pages);
			...
			$options[] = array(
				'name' => __('Block 3 Img', 'options_framework_theme'),
				'id' => 'block3img',
				'type' => 'upload');
			$options[] = array(
				'name' => __('Block 3 Text', 'options_framework_theme'),
				'id' => 'block3text',
				'type' => 'text');
			$options[] = array(
				'name' => __('Block 3 Target', 'options_framework_theme'),
				'id' => 'block3url',
				'type' => 'select',
				'options' => $options_pages);

			$options[] = array(
				'name' => __('Block 4 Img', 'options_framework_theme'),
				'id' => 'block4img',
				'type' => 'upload');
			$options[] = array(
				'name' => __('Block 4 Text', 'options_framework_theme'),
				'id' => 'block4text',
				'type' => 'text');
			$options[] = array(
				'name' => __('Block 4 Target', 'options_framework_theme'),
				'id' => 'block4url',
				'type' => 'select',
				'options' => $options_pages);
