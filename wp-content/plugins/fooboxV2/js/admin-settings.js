jQuery(document).ready(function($) {
    ...
    $('.icons_radio a').click(function(e) {
        $('.icons_radio a').removeClass('selected');

        $(this).addClass('selected');
    });

    $('.colours_radio a').click(function(e) {
        $('.colours_radio a').removeClass('selected');

        $(this).addClass('selected');
    });

    $('.loaders_radio a').click(function(e) {
        $('.loaders_radio a').removeClass('selected');
